<template>
  <view class="psychologist-container" :style="{'--theme-color': themeColor}">
    <!-- 顶部导航 -->
    <view class="header">
        ...
        >
          <view class="card-header">
            <view class="avatar-container">
              <image :src="doctor.avatar" class="doctor-avatar" mode="aspectFill"/>
              <view class="online-status" :class="{online: doctor.isOnline}"></view>
            </view>
            <view class="doctor-info">
              <view class="name-section">
                <text class="doctor-name">{{doctor.name}}</text>
                <text class="doctor-gender">{{doctor.gender === '男' ? '👨‍⚕️' : '👩‍⚕️'}}</text>
              </view>
              <view class="basic-info">
                <text class="info-item">{{doctor.age}}岁</text>
                <text class="info-item">医龄{{doctor.experience}}年</text>
                <text class="info-item">{{doctor.title}}</text>
              </view>
            </view>
          ...
          <view class="card-footer">
            <view class="action-buttons">
              <button class="appointment-btn" @click.stop="makeAppointment(doctor)">
                预约咨询
              </button>
            </view>
          </view>
      ...
      <view class="detail-content" @click.stop>
        <view class="detail-header">
          <view class="doctor-profile">
            <image :src="selectedDoctor.avatar" class="detail-avatar" mode="aspectFill"/>
            <view class="profile-info">
              <text class="detail-name">{{selectedDoctor.name}}</text>
              <text class="detail-title">{{selectedDoctor.title}}</text>
            </view>
          </view>
        ...
        <view class="detail-body">
          <view class="detail-section">
            ...
            <view class="info-grid">
              <view class="info-item">
                ...
                <text class="info-value">{{selectedDoctor.gender}}</text>
              </view>
              <view class="info-item">
                <text class="info-label">年龄</text>
                <text class="info-value">{{selectedDoctor.age}}岁</text>
              </view>
              <view class="info-item">
                <text class="info-label">医龄</text>
                <text class="info-value">{{selectedDoctor.experience}}年</text>
              </view>
              <view class="info-item">
                <text class="info-label">职称</text>
                <text class="info-value">{{selectedDoctor.title}}</text>
              </view>
            </view>
          </view>
          ...
          <view class="detail-section">
            ...
            <text class="detail-intro">{{selectedDoctor.introduction}}</text>
          </view>
          
          <view class="detail-section">
            <text class="section-label">专业背景</text>
            <text class="detail-background">{{selectedDoctor.background}}</text>
          </view>
          
        </view>
        
        <view class="detail-footer">
          <button class="detail-appointment-btn" @click="makeAppointment(selectedDoctor)">
            预约咨询
          </button>
        </view>
      </view>
...
.detail-section {
  ...
  .detail-intro, .detail-background {
    font-size: 26rpx;
    color: #333;
    line-height: 1.6;
