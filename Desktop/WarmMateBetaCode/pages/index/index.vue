<template>
	<view class="page-container">
		...
		<!-- 卡片列表区域 -->
		<scroll-view class="content" :style="{ minHeight: screenMinHeight + 'rpx' }" scroll-y :enable-back-to-top="true"
			@scrolltolower="loadMore">
			<!-- 卡片容器：flex双列布局 -->
			<view class="content-wrapper">
				<view class="card-container">
					<!-- 循环生成卡片 -->
					<view v-for="(item, index) in cardList" :key="item.id" class="card"
						:style="{ background: item.gradient }" @click="navigateTo(item.path)">
