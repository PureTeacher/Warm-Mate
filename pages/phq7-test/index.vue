      ...
      >
        ...
        <view class="test-info">
          ...
          <view class="test-meta">
            <text class="meta-item">{{test.questionCount}}题 · 约{{test.duration}}分钟</text>
          </view>
        </view>
      </view>
    </view>
      ...
      <view class="test-info-popup">
        ...
        <scroll-view scroll-y class="popup-content">
          ...
          <view class="warning-box">
            <text class="emoji">⚠️</text>本测评结果仅供参考，不能作为临床诊断依据
          </view>
        </scroll-view>
        <button class="start-btn" @click="confirmStart">开始测评</button>
      </view>
    </uni-popup>
  </view>
</template>
